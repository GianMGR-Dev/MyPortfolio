...
const Navbar = () => {
    ...
    return (
        <nav className='relative w-full h-auto bg-[var(--secondary-color)] z-10'>
            ...
            {isOpen && (
                <div className='absolute w-full min-h-screen flex flex-col justify-center items-center bg-[var(--secondary-color)] p-2 md:hidden md:gap-4 md:py-3 z-10 top-0 right-0 animate-fade-in-left'>
